...
# valitation_data.Validation
# 評価用データを作成および読みこみ

# training_data.Training
# 訓練用データを作成およびデータ拡張後の読みこみ

# learning.Learning
# learning.plot_hist
# modelの定義およびコンパイル、学習、保存、学習経過のプロット

# result_analysis.AnalysisBinary
# result_analysis.AnalysisMulti
# result_analysis.summary_analysis
# result_analysis.cross_making
# 結果の分析
